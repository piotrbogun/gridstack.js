...
class GridStack {
    ...
    static addGrid(parent, opt = {}) {
        ...
        if (el.gridstack) {
            ...
            if (opt)
                grid.opts = Object.assign(Object.assign({}, grid.opts), opt);
    ...
    constructor(el, opts = {}) {
        ...
        let parentGridItem = (_a = Utils.closestUpByClass(this.el, gridDefaults.itemClass)) === null || _a === void 0 ? void 0 : _a.gridstackNode;
        if (parentGridItem) {
    ...
    makeSubGrid(el, ops, nodeToAdd, saveContent = true) {
        ...
        ops = Utils.cloneDeep(Object.assign(Object.assign(Object.assign({}, (subGridTemplate || {})), { children: undefined }), (ops || node.subGridOpts)));
    ...
    static setupDragIn(dragIn, dragInOptions, root = document) {
        ...
        dragInOptions = Object.assign(Object.assign({}, dragInDefaultOptions), (dragInOptions || {}));
